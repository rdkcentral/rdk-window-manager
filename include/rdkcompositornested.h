...
#ifndef RDK_WINDOW_MANAGER_RDK_COMPOSITOR_NESTED_H
#define RDK_WINDOW_MANAGER_RDK_COMPOSITOR_NESTED_H
    ...
    class RdkCompositorNested:public RdkCompositor
    {
        public:
            bool createDisplay(const std::string& displayName, const std::string& clientName,
                ...
                const std::string& capabilities = std::string());
    };
}

#endif //RDK_WINDOW_MANAGER_RDK_COMPOSITOR_NESTED_H
