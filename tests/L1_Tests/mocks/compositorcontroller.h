...
extern bool (*setFocus)(const std::string&);
extern bool (*setBounds)(const std::string&, uint32_t, uint32_t, uint32_t, uint32_t);
extern bool (*getVirtualDisplayEnabled)(const std::string&, bool&);
extern bool (*getClients)(std::vector<std::string>&);
extern bool (*getClientName)(WstCompositor*, std::string&);
extern bool (*getFireboltSurface)(const std::string& ,int,uint32_t);
extern bool (*setFireboltSurfaceName)(const std::string& client, int surfaceId, const std::string& surfaceName);
extern bool (*setFireboltSurfaceName)(const std::string& client, int surfaceId, const std::string& surfaceName);
extern bool (*setFireboltSurfaceOpacity)(const std::string& client, int surfaceId, double opacity);
extern bool (*setFireboltSurfaceBounds)(const std::string& client, int surfaceId, int32_t x, int32_t y, uint32_t width, uint32_t height);
extern bool (*setFireboltSurfaceCrop)(const std::string& client, int surfaceId, int32_t sx, int32_t sy, uint32_t swidth, uint32_t sheight);
