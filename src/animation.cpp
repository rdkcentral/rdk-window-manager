...
namespace RdkWindowManager
{
    ...
    void Animator::animate()
    {
        ...
        std::vector<std::map<std::string, RdkWindowManagerData>> animationList;
        for (auto it = animations.begin(); it != animations.end(); ++it)
        {
            ...
            if (animation.compositor != nullptr)
            {
                ...
                animationList.push_back(std::map<std::string, RdkWindowManagerData>());
                std::map<std::string, RdkWindowManagerData>& animationData = animationList.back();
    ...
    void Animator::addAnimation(Animation animation)
    {
        ...
        animation.startTime = RdkWindowManager::seconds() + animation.delay;
        animation.endTime = RdkWindowManager::seconds() + animation.delay + animation.duration;
        animation.prepare();
