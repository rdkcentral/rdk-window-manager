...
namespace RdkWindowManager
{
    ...
    bool addAnimationHandler(int id, const rapidjson::Value& params, void* context)
    {
        ...
        std::map<std::string, RdkWindowManagerData> animationProperties;
    ...
    void ServerMessageHandler::onAnimation(std::vector<std::map<std::string, RdkWindowManagerData>>& animationData)
    {
        std::stringstream response;
        ...
        {
            std::map<std::string, RdkWindowManagerData>& data = animationData[i];
            if (!isFirstClient)
            {
                response << ",";
            }
